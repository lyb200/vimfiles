...
nnoremap S :w
map Y y$
vmap <silent> YI :call ForAllMatches('yank',   {'visual':1, 'inverse':1})
vmap <silent> YM :call ForAllMatches('yank',   {'visual':1})
nmap <silent> YI :     call ForAllMatches('yank',   {'inverse':1})
nmap <silent> YM :     call ForAllMatches('yank',   {})
vnoremap <silent> ZZ ZZ
...
nmap sH tK
nmap sV tH
nmap sk :set nosplitbelow:split
nmap sj :set splitbelow:split
nmap sh :set nosplitright:vsplit
nmap sl :set splitright:vsplit
nmap s <Nop>
...
vnoremap <silent> <Plug>(coc-explorer-action-v-v) :call coc#rpc#request('doKeymap', ['explorer-action-v-v'])
nnoremap <silent> <Plug>(coc-explorer-action-n-v) :call coc#rpc#request('doKeymap', ['explorer-action-n-v'])
...
vnoremap <silent> <Plug>(coc-explorer-action-v-[esc]) :call coc#rpc#request('doKeymap', ['explorer-action-v-[esc]'])
nnoremap <silent> <Plug>(coc-explorer-action-n-[esc]) :call coc#rpc#request('doKeymap', ['explorer-action-n-[esc]'])
...
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\vim-vinegar
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\nerdtree-git-plugin
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\vim-airline
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\ctrlp.vim
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\yankmatches
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\vim-dragvisuals
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\foldsearches.vim
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\coc.nvim
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\vim-fugitive
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\persistentvisuals
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\syntastic
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\vim-surround
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\vim-commentary
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\emmet-vim
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\vim-easymotion
set runtimepath+=C:\\Program\ Files\\Vim\\vimfiles\\plugged\\vimspector
set runtimepath+=C:\\Program\ Files\\Vim/vimfiles
set runtimepath+=C:\\Program\ Files\\Vim\\vim82
...
silent only
silent tabonly
cd C:\Program\ Files\Vim\vim82\doc
...
wincmd w
argglobal
if bufexists("C:\Program\ Files\Vim\vim82\doc\eval.txt") | buffer C:\Program\ Files\Vim\vim82\doc\eval.txt | else | edit C:\Program\ Files\Vim\vim82\doc\eval.txt | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1372 - ((29 * winheight(0) + 17) / 35)
